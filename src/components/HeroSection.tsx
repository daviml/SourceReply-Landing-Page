      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="fade-up inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted/50 border border-border/50 mb-8">
            ...
            <span className="text-sm text-muted-foreground">IA Local • Zero Cloud • 100% Privado</span>
          </div>

          {/* Headline */}
          <h1 className="fade-up-delay-1 text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6">
            Pare de queimar horas de{" "}
          ...
          <div className="fade-up-delay-3 flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button variant="hero" size="xl" className="w-full sm:w-auto gap-2">
              ...
              Baixar para Windows - 14 Dias Grátis
            </Button>
          ...
          <div className="fade-up-delay-4 flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground flex items-center gap-2">
              ...
              Usado por equipes que prezam pela privacidade
            </p>
          </div>
        </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 rounded-lg bg-muted/30 border border-border/30">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium">Projeto Local</span>
                      </div>
                    ...
                    <div className="p-3 rounded-lg bg-neon-purple/10 border border-neon-purple/30">
                      <div className="text-sm font-medium text-neon-purple">47 Chamados</div>
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <div className="p-4 rounded-lg bg-muted/20 border border-border/30">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          <div className="text-sm font-medium mb-1">#1847 - Erro de autenticação</div>
                          <div className="text-xs text-muted-foreground">Usuário não consegue fazer login após atualização</div>
                        </div>
                    ...
                    <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium text-green-400">Diagnóstico Concluído</span>
                      </div>
                      <div className="text-xs text-muted-foreground">
                        Causa identificada em <span className="text-foreground">auth/tokenService.ts:127</span>
                      </div>
                    </div>
                  </div>
                </div>
